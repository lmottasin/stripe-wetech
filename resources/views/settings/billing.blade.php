    ...
    <div class="bg-gray-200 min-h-screen pb-24">
        ...
        <div class="container mx-auto max-w-3xl mt-8">
            ...
            @if(auth()->user()->subscribed('main'))
                {{--            modal for switching plan js,css added starts--}}
                <div id="switch-plans-modal" class="fixed w-full h-full inset-0 z-50 ">
                    ...
                    <form method="POST" action="{{ route('billing.switch_plan') }}"
                          class="absolute bg-white rounded-lg p-5"
                          id="switch-plans">
                        @csrf
            ...
            <form action="{{ route('billing.save') }}" id="billing-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="md:w-2/3 w-full">
                        @if(auth()->user()->subscribed('main'))
                            <div class="py-8 px-16">
                                ...
                                <div class="flex">
                                    <img src="/img/plans/{{ auth()->user()->plan->pricing_api_id }}.png"
                                         class="w-16 h-16 mr-3">
                                    <div>
                                        <span class="block">Subscribed to {{ ucfirst(auth()->user()->plan->plan_name) }} Plan</span>
                                        <span
                            ...
                            <div class="py-8 px-16">
                                ...
                                <div class="text-xs text-gray-500">To update your default payment method, add a new card
                                    below:
                                </div>
                            </div>
                            <hr class="border-gray-300">
                        @endif
                        {{--                        Trial notifiction starts--}}
                        ...
                        <div class="py-8 px-16">
                            ...
                            <input
                                ...
                                id="card-holder-name" type="text">
                        </div>
                        <hr class="border-gray-300">
                        <div class="py-8 px-16">
                            <label for="cc" class="text-sm text-gray-600">Credit Card</label>
                            <div id="card-element"
                                 class="mt-2 border-2 border-gray-200 px-3 py-2 block w-full rounded-lg text-base text-gray-900 focus:outline-none focus:border-indigo-500"></div>
                ...
                <div class="p-16 py-8 bg-gray-300 clearfix rounded-b-lg border-t border-gray-200">
                    <p class="float-left text-xs text-gray-500 tracking-tight mt-2">Click on Save to update your Billing
                        Info</p>
