<header class="px-6 bg-white lg:py-0 py-2">
    <div class="container mx-auto flex flex-wrap items-center">
        <div class="flex-1 flex justify-between items-center font-black text-gray-700">
            <a href="{{ route('dashboard.index') }}">LOGO</a>
        </div>
        ...
        <div class="hidden lg:flex lg:items-center lg:w-auto w-full relative" id="menu">
            <nav>
                <ul class="lg:flex items-center justify-between text-sm font-medium text-gray-700 pt-4 lg:pt-0">
                    <li>
                        <a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent font-bold @if(Request::is('dashboard')){{ ' text-indigo-500 ' }}@else{{ 'text-gray-600 hover:text-gray-900' }}@endif"
                           href="{{ route('dashboard.index') }}">Dashboard</a></li>

                    <li>
                        <a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent font-bold @if(Request::is('support')){{ ' text-indigo-500 ' }}@else{{ 'text-gray-600 hover:text-gray-900' }}@endif lg:mb-0 mb-2"
                           href="{{ route('support') }}">Support</a></li>
                    <li>
                        <a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent @if(Request::is('announcements/unread')){{ 'text-indigo-500 ' }}@else{{ 'text-gray-500 hover:text-gray-700' }}@endif lg:mb-0 mb-2 relative"
                           href="{{ route('announcements.unread') }}">
                            ...
                            <span
                                class="bg-pink-500 w-2 h-2 rounded-full absolute left-0 top-0 ml-3 mt-4 announcement-indicator"></span>
                                                    @endif
                            <svg width="15px" height="18px" class="fill-current" xmlns="http://www.w3.org/2000/svg">
                                <g id="Page-1" stroke="none" stroke-width="1">
                                    <g id="noun_notification_1594286" transform="translate(-59)">
                                        <g id="Group" transform="translate(59)">
                                            <path
                                                d="M6.094 2.271c-2.426.642-4.219 2.907-4.219 5.604v3.857c0 .355-.28.643-.624.643-.691 0-1.251.577-1.251 1.286v.965c0 .177.139.32.313.32h14.374a.318.318 0 00.313-.32v-.965c0-.71-.563-1.286-1.25-1.286a.633.633 0 01-.625-.643V7.875c0-2.696-1.792-4.961-4.219-5.604v-.664c0-.8-.63-1.446-1.406-1.446-.775 0-1.406.647-1.406 1.446v.664zM5.312 15.59h4.375c0 1.243-.979 2.25-2.187 2.25-1.208 0-2.188-1.007-2.188-2.25z"
                                                id="Shape"/>
                                        </g>
                                    </g>
                                </g>
            ...
            <a href="#"
               ...
               id="userdropdown">
                <p class="font-bold text-xs pr-2 text-gray-700 text-right ignore-body-click">{{ auth()->user()->name }}
                    <br>
                ...
                <img
                    class="rounded-full w-10 h-10 border-2 border-gray-300 group-hover:border-pink-400 ignore-body-click"
            ...
            <div id="usermenu"
                ...
                <div class="bg-white shadow-xl lg:px-8 px-6 lg:py-4 pb-4 pt-0 rounded  rounded-t-none">
                    ...
                    <a href="/logout"
                       class="block text-gray-600 hover:text-gray-900 font-medium ignore-body-click">Logout</a>
                </div>
            </div>
