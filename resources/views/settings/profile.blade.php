        ...
        <form action="{{ route('profile.save') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="w-full bg-white rounded-lg mx-auto mt-8 flex overflow-hidden rounded-b-none">
                <div class="w-1/3 bg-gray-100 p-8 hidden md:inline-block">
                    ...
                    <p class="text-xs text-gray-500">Update your basic profile information such as Email Address,
                        Name, and Image.</p>
                </div>
                <div class="md:w-2/3 w-full">
                    ...
                    <div class="py-8 px-16 clearfix">
                        ...
                        <img class="rounded-full w-16 h-16 border-4 mt-2 border-gray-300 float-left" id="photo"
                             src="{{ Auth::user()->photo }}"
                             alt="photo">
                        <div
