...
@section('content')
    ...
    <section class="text-center pt-32 pb-40 bg-pink-500 relative">
        ...
        <div class="container mx-auto text-center px-5">
            ...
            <form class="block sm:flex w-full px-0 sm:px-16 xl:pr-6 lg:pr-16 md:px-32 lg:px-0 lg:w-1/2 lg:m-auto lg:mt-8" action="https://devdojo.us10.list-manage.com/subscribe/post?u=40a7d08f5c82f392a291d8a7e&amp;id=b5ca288537" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" target="_blank" novalidate="">
