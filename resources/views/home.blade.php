...
@section('content')
    ...
    <div class="h-24 w-full relative z-50">

        <div class="container max-w-6xl mx-auto h-full flex justify-center sm:justify-between items-center px-8 xl:px-0">
            <a href="/" class="inline-block h-full flex items-center h-5 relative font-black">
                <svg class="h-8 w-auto fill-current text-gray-900" viewBox="0 0 281 280" height="280" xmlns="http://www.w3.org/2000/svg"><path d="M140 0C89.592-.006 43.073 27.088 18.206 70.935-6.66 114.78-6.037 168.61 19.84 211.87a135.373 135.373 0 006.73 10.2c40.925 56.523 117.212 74.304 178.91 41.7l-11.29-19.51c-42.055 21.797-93.087 16.206-129.426-14.178-36.34-30.384-50.88-79.618-36.875-124.869C41.893 59.963 81.7 27.547 128.85 23c3.67-.34 7.39-.52 11.15-.52 3.76 0 7.47.18 11.14.52 42.314 4.012 79.16 30.57 96.344 69.444 17.185 38.875 12.028 84-13.484 117.996L140 47.9 52.19 200h33.87L140 106.56l72.75 125.69 11.38 19.66c48.149-36.192 67.751-99.125 48.67-156.258C253.72 38.52 200.235-.004 140 0z"/></svg>
                <span class="font-black ml-2 text-gray-900 text-xl">SAAS</span>
            </a>


            <nav id="nav" class="absolute w-full sm:w-auto flex-col sm:flex-row h-24 sm:h-auto justify-center bg-white sm:bg-transparent top-0 mt-24 sm:mt-0 border-t sm:border-none border-gray-200 pt-5 sm:py-0 z-50 flex hidden sm:flex items-center sm:relative">
                <a href="/" class="font-bold ml-0 sm:ml-12 mr-0 sm:mr-5 text-sm transition-color duration-100 hover:text-indigo-600">Home</a>
                <a href="#how-it-works" class="font-bold mr-0 sm:mr-5 text-sm transition-color duration-100 hover:text-indigo-600">Features</a>
                <a href="" class="font-bold text-sm transition-color duration-100 hover:text-indigo-600">Pricing</a>

            </nav>

            <div id="navAuth" class="absolute sm:relative w-full sm:w-auto bg-white sm:bg-transparent border-b sm:border-none border-gray-200 mt-48 sm:mt-0 flex-col sm:flex-row pb-8 sm:p-0 justify-center items-center sm:items-end flex hidden sm:flex sm:justify-between ">
                <a href="#_" class="px-5 py-2 text-sm text-pink-500 lg:text-white font-bold mr-0 sm:mr-3 relative z-40">Login</a>
            ...
            <div id="nav-mobile-btn" class="w-6 absolute block sm:hidden right-0 top-0 mr-10 mt-8 sm:mt-10 z-50 cursor-pointer select-none">
    ...
    <!-- BEGIN HERO SECTION -->
    <div class="w-full lg:h-screen w-screen justify-center items-center relative  overflow-x-hidden">

        <div class="container max-w-6xl mx-auto h-full flex flex-col lg:flex-row justify-between items-center -mt-32 xl:px-0 px-8">
            ...
            <div class="flex flex-col items-center lg:items-start w-full max-w-xl lg:w-1/2 pt-48 lg:pt-20 xl:pt-40 text-center lg:text-left z-30">
                <h1 class="text-gray-900 font-bold text-4xl sm:text-6xl leading-tight relative mb-4 xl:mb-8">Build the Next Great Thing</h1>
                <p class="text-sm sm:text-lg xl:text-xl text-gray-600 mb-8 pr-0 lg:pr-20">Are you ready to start your adventure and start building the next greatest SAAS app on the market?</p>
                <a href="#_" class="mt-0 sm:mt-1 px-5 py-3 rounded fold-bold text-base bg-indigo-600 shadow-xl text-white border-t border-gray-200 w-auto font-bold relative self-start inline-block lg:mx-0 mx-auto">Signup Today!</a>
    ...
    <div class="w-full relative -mt-24">
        <div class="container max-w-6xl mx-auto h-full flex flex-col justify-between items-center border-none sm:border-t border-gray-200 pt-24">
            <h2 class="text-lg font-medium text-gray-600 relative items-center w-full text-center uppercase tracking-widest">Features</h2>
    ...
    <!-- Pricing Section -->
    <div class="bg-white pt-6 lg:pt-24 pb-10 relative" id="pricing">

        <div class="container max-w-6xl mx-auto h-full flex flex-col items-center border-none lg:border-t border-gray-300 pt-0 lg:pt-24">
            <h2 class="text-lg font-medium text-gray-600 relative items-center w-full text-center uppercase tracking-widest">Pricing</h2>
            ...
            <div class="max-w-full md:max-w-6xl mx-auto my-2 sm:my-24 sm:px-8">
                <!-- Basic Pricing -->
                    ...
                    <div class="w-11/12 max-w-sm sm:w-3/5 lg:w-1/3 sm:my-5 my-8 relative z-0 rounded-lg md:-mr-4 border border-gray-200">
                        <div class="bg-white text-black rounded-lg border-t border-gray-100 shadow-sm overflow-hidden">
                            ...
                            <div class="block flex items-center p-8  uppercase">
                                <a href="#_" class="mt-3 text-lg font-semibold bg-gray-900 w-full text-white rounded px-6 py-3 block shadow-sm hover:bg-indigo-600 text-center">Select This Plan</a>
                            </div>
                        </div>
                    </div>
                    <!-- Pro Pricing -->
                    <div class="w-full max-w-md sm:w-2/3 lg:w-1/3 sm:my-5 my-8 relative z-10 bg-white rounded-lg shadow-lg">
                        <div class="text-sm leading-none rounded-t bg-gray-900 text-white font-semibold uppercase py-4 text-center tracking-wide">Most Popular</div>
                        <div class="block text-left text-sm sm:text-md max-w-sm mx-auto mt-5 text-black px-8 lg:px-6">
    ...
    <footer class="bg-black text-white pt-12 pb-8 px-4">
        <div class="mx-auto px-4 container overflow-hidden max-w-6xl flex flex-col lg:flex-row justify-between">
            <a href="/" class="block mr-4 w-1/3">
                <span class="flex items-center">
                    <svg class="h-6 w-auto fill-current text-white" viewBox="0 0 281 280" height="280" xmlns="http://www.w3.org/2000/svg"><path d="M140 0C89.592-.006 43.073 27.088 18.206 70.935-6.66 114.78-6.037 168.61 19.84 211.87a135.373 135.373 0 006.73 10.2c40.925 56.523 117.212 74.304 178.91 41.7l-11.29-19.51c-42.055 21.797-93.087 16.206-129.426-14.178-36.34-30.384-50.88-79.618-36.875-124.869C41.893 59.963 81.7 27.547 128.85 23c3.67-.34 7.39-.52 11.15-.52 3.76 0 7.47.18 11.14.52 42.314 4.012 79.16 30.57 96.344 69.444 17.185 38.875 12.028 84-13.484 117.996L140 47.9 52.19 200h33.87L140 106.56l72.75 125.69 11.38 19.66c48.149-36.192 67.751-99.125 48.67-156.258C253.72 38.52 200.235-.004 140 0z"/></svg>
                    <span class="font-black ml-2 text-lg">SAAS</span>
                </span>
            </a>
            <div class="w-2/3 block sm:flex text-sm mt-6 lg:mt-0">
                <ul class="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                    ...
                    <li><a href="#_" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Features</a></li>
                    <li><a href="#_" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Integrations</a></li>
                    <li><a href="#_" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Pricing</a></li>
                    <li><a href="#_" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">FAQ</a></li>
                </ul>
                <ul class="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                    <li class="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">Company</li>
                    <li><a href="#_" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Privacy</a>
                    </li>
                    <li><a href="#_" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Terms of Service</a></li>
                </ul>
                <ul class="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                    <li class="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">Developers</li>
                    <li><a href="#_" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Developer API</a></li>
                    <li><a href="#_" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Documentation</a></li>
                    <li><a href="#_" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Guides</a></li>
                    </li>
                </ul>
                <div class="text-gray-700 flex flex-col w-full">
                    ...
                    <div class="flex pl-4 justify-start mt-2">
                        <a class="block flex items-center text-gray-300 hover:text-white mr-6 no-underline" target="_blank" href="https://devdojo.com">
                        ...
                        <a class="block flex items-center text-gray-300 hover:text-white no-underline" target="_blank" href="https://devdojo.com">
                            <svg viewBox="0 0 24 24" class="fill-current w-5 h-5" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="pt-4 mt-10 pt-6 text-gray-600 border-t border-gray-800 text-center"> © 2020 SAAS App. All rights reserved.</div>
    </footer>
    <!-- Just a little JS for the slider (#How Does It Work) section -->
    <script>
        ...
        for(var i=0; i < slideBtns.length; i++){
            slideBtns[i].addEventListener('click', function(){
                // set all slide opacity to 0
                for(var j=0; j<slides.length; j++){
                    slides[j].classList.add('opacity-0');
                }
                // set all slide buttons to inactive
                for(var k=0; k<slideBtns.length; k++){
