...
@section('content')
    ...
    <section class="font-sans container m-auto flex px-5">
        ...
        <div class="flex-1 flex items-start flex-col justify-center">
            <h1 class="my-4 font-medium mt-40 lg:mt-32 lg:mt-0 text-center w-full px-2 text-gray-800 text-2xl xl:text-5xl lg:px-0 font-black mb-8 md:w-full lg:text-left h-auto xl:h-32"><span class="block">A Course Platform for</span> <span id="title" class="text-pink-500"></span></h1>
            <p class="leading-normal mb-12 pr-36 text-normal xl:text-base text-center w-full px-16 text-gray-600 leading-loose xl:pr-32 md:text-center md:px-32 sm:text-center lg:text-left lg:px-0">Create a kickass course and integrate your favorite services including stripe, braintree, mailchimp, and many others!</p>
            <div class="flex justify-center items-center flex-col mb-12">
                ...
                <div class="max-w-5xl">
                    ...
                    <a href="/register" class="bg-pink-500 text-gray-100 hover:text-white shadow font-bold py-3 pl-4 pr-8 rounded-full flex justify-start items-center cursor-pointer text-sm w-full mt-4">
    ...
    <section class="text-center pt-32 pb-40 bg-pink-500 relative">
        ...
        <div class="container mx-auto text-center px-5">
            ...
            <a href="/register" class="px-8 py-4 bg-indigo-500 rounded-full text-white text-lg inline-block font-bold shadow-xl">Signup With Email</a>
        </div>
